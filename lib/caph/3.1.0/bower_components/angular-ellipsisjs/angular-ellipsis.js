...
//			scope.someCtrlFn({arg1: 'nilsichoo'});
//		},
...
//				scope.someCtrlFn({arg1: 'nilsichoo'});
				...
				function buildEllipsis() {
					console.log("-----------inside buildEllipsis-----------");
					...
					if (binding) {
						...
						//element.attr('edensFlag', 'false');
						// If text has overflow
						if (isOverflowed(element, scope.useParent)) {
							//console.log("ELLIPSIS: overflowed!!!");
							...
							//console.log("ELLIPSIS: no overflow!!!");

							if (element.attr('id') == 'overview'){
								//document.getElementById("invisibleReadMore").style.display = "none";
								//scope.disable('readMore');
							}
							if (element.attr('id') == 'actorBio'){
								//document.getElementById("invisibleReadMore2").style.display = "none";
								//scope.disable('invisibleReadMore2');
							} 
							element.attr('data-overflowed', 'false');
//							if (isHtml) {
//								element.html(binding + "<span style = 'visibility:hidden'>א<br>א</span>");
//								//console.log("//////!there's a hidden aleph!////////");
//							} else {
//								element.text(binding).html(element.html() + "<span style = 'visibility:hidden'>א<br>א</span>");
//								//console.log("//////!there's a hidden aleph!////////");
//							}
//							if (isHtml) {
//								element.html(binding + "<span>א</span>");
//								//console.log("//////!there's a hidden aleph!////////");
//							} else {
//								element.text(binding).html(element.html() + "<span>א<br>א</span>");
//								//console.log("//////!there's a hidden aleph!////////");
//							}
						}
					}
					console.log("------------out buildEllipsis---------------");
				}
